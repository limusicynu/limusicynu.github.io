...
+function ($) {
    ...
    var Calendar = function (params) {
        ...
        p.onYearsChangeEnd = function (dir) {
            ...
            if (dir === 'next') {
                 newCurFirstYear = parseInt(p.yearsPickerWrapper.children('.picker-calendar-years-next').find('.picker-calendar-year-unit').eq(Math.floor(yearNum/2)).text());
            ...
            if (dir === 'prev') {
                 newCurFirstYear = parseInt(p.yearsPickerWrapper.children('.picker-calendar-years-prev').find('.picker-calendar-year-unit').eq(Math.floor(yearNum/2)).text());
